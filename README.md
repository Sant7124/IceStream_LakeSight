...
### 2. Backend Setup (Render Free Web Service — $0 / month)
1. In Render, create a Web Service connected to your repo (or use 1-click `render.yaml` Blueprint).
2. Set **Root Directory** to `backend`.
3. Build command: `pip install -r requirements.txt`
4. Start command: `uvicorn app.api.main:app --host 0.0.0.0 --port $PORT`
5. Set `ALLOWED_ORIGINS` to your deployed frontend domain:
   ```env
...
```bash
git clone https://github.com/Sant7124/IceStream_LakeSight.git
cd IceStream_LakeSight
cp .env.example .env
```
...
| **Santosh Yadav** |
| :---: |
| Lead Data & Observability Engineer • System Architect |
| [@Sant7124](https://github.com/Sant7124) |
